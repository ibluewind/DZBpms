...
<body>
	...
	<%@ include file="adminMenu.jsp" %>
		<div class="row">
			...
			<div class="col-md-9">
				<iframe id="userWorkspace" style="border:0; display:block; width:100%; height:100%" frameborder="0" scrolling="no"></iframe>
			</div>
		</div>
	</div>
	<script>
		...
		function loadDepartmentTree(companyId) {
			...
			.on("changed.jstree", function (e, node) {
				...
				var href = "<c:url value='/user/list/'/>" + id;
				
				console.log('pid = ' + pid + ', id = ' + id + ', href= ' + href);
				$('#userWorkspace').attr('src', href);
				$('#userWorkspace').load(function() {
