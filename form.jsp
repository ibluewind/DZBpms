...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="panel-title">${form.title}</div>
	</div>
	<div class="panel-body">
		<form name="form" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-11">
					<input type="text" class="form-control input-sm" ng-model="ctrl.form.fields['userName']">
				</div>
			</div>
			<div class="row">
					...
					<table class="table table-condensed">
						...
						<tbody>
							<tr ng-repeat="field in ctrl.form.fields['fieldRows'][0] track by $index">
								<td>
									<select class="form-control input-sm" ng-model="field.type">
							...
							<tr>
								<td colspan="6">
									<button type="button" class="btn btn-default btn-sm" ng-click="ctrl.addField(0)">항목추가</button>
								</td>
							</tr>
						</tbody>
					</table>
